...
> 文档版本：v0.3 长篇创作基线
> 更新日期：2026-08-24
> 当前状态：桌面骨架、项目与章节管理闭环、正文审阅链路、故事规划中心、人物关系图、地点视图、跨卷情节弧、知识与连续性、章后状态提取、知识条目逐条签批与 AI 连续性审计、模型诊断、长篇上下文，以及提示词与文风管理中心已经完成；导入导出与发布工程仍按后续阶段推进。
...
1. TXT、Markdown、JSON、Word 导入导出与项目备份；
2. 完整供应商能力探测、重试队列和生成记录；
3. CI、跨平台安装包、签名与开源文档；
4. 网页端服务协议与部署方案评估。
